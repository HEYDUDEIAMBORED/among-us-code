...
function draw(){
    ...
    if (gameState==='play'){
      ...
      //  if(room1.y-player.y===50 && Usebutton.mousePressed(function(){console.log("press")}){task1s.visible=true}
...
function play(){
    ...
    //camera(player.x,player.y,20,player.x,player.y,20,0,1,0)
    textSize(50)
    Usebutton=createButton('USE')
    Usebutton.position(displayWidth-200,displayHeight-300)
    Usebutton.size(100,100)
